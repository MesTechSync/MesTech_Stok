...
public class N11AvaloniaViewModelTests
{
    private static N11AvaloniaViewModel CreateSut()
    {
        var mediatorMock = new Mock<IMediator>();
        return new N11AvaloniaViewModel(mediatorMock.Object, Mock.Of<ICurrentUserService>());
    }
