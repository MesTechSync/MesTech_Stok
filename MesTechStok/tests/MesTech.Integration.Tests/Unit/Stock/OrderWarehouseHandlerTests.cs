...
using MesTech.Application.Features.Orders.Commands.BatchShipOrders;
using MesTech.Application.Features.Orders.Commands.AutoShipOrder;
using MesTech.Application.Features.Orders.Commands.CreateAutoOrder;
using MesTech.Application.Features.Orders.Queries.ListOrders;
using MesTech.Application.Features.Orders.Queries.GetStaleOrders;
using MesTech.Application.Features.Warehouse.Queries.GetWarehouses;
using MesTech.Application.Features.Warehouse.Queries.GetWarehouseById;
using MesTech.Application.Features.Warehouse.Queries.GetWarehouseStock;
using MesTech.Application.Features.Warehouse.Queries.GetWarehouseSummary;
