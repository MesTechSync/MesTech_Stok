...
{
    [Obsolete("MIGRATE: Use MesTech.Domain.Entities.Warehouse (Guid PK). Bridge via ExternalId property. Will be removed in Dalga 6.")]
    public class Warehouse
    {
        ...
        /// <summary>
        /// Domain.Warehouse (Guid PK) ile korrelasyon köprüsü.
