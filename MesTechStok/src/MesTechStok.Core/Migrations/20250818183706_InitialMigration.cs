        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValidationMessage = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    RawLength = table.Column<int>(type: "int", nullable: false),
                    TimestampUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CorrelationId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpenCartCategoryId = table.Column<int>(type: "int", nullable: true),
                    LastSyncDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SyncWithOpenCart = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewState = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Reason = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    FailureRate = table.Column<double>(type: "float", nullable: false),
                    WindowTotalCalls = table.Column<int>(type: "int", nullable: false),
                    TransitionTimeUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CorrelationId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Segment = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ...
                    FacebookProfile = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    InstagramProfile = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    LinkedInProfile = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    DocumentUrls = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    OpenCartCustomerId = table.Column<int>(type: "int", nullable: true),
                    LastSyncDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SyncWithOpenCart = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfflineQueue", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxOffice = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    VatNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    TradeRegisterNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    PaymentTermDays = table.Column<int>(type: "int", nullable: false),
                    CreditLimit = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CurrentBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DiscountRate = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemData = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ...
                    LastRetryUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsableArea = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    Height = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    MaxCapacity = table.Column<decimal>(type: "decimal(15,3)", nullable: true),
                    ...
                    MinHumidity = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    MaxHumidity = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    HasClimateControl = table.Column<bool>(type: "bit", nullable: false),
                    HasSecuritySystem = table.Column<bool>(type: "bit", nullable: false),
                    HasFireProtection = table.Column<bool>(type: "bit", nullable: false),
                    HasLoadingDock = table.Column<bool>(type: "bit", nullable: false),
                    HasRacking = table.Column<bool>(type: "bit", nullable: false),
                    HasForklift = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    MonthlyCost = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CostPerSquareMeter = table.Column<decimal>(type: "decimal(10,4)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpenCartOrderId = table.Column<int>(type: "int", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VolumeText = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Desi = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    LeadTimeDays = table.Column<int>(type: "int", nullable: true),
                    ShipAddress = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ReturnAddress = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    UsageInstructions = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ImporterInfo = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ManufacturerInfo = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Tags = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Code = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    OpenCartProductId = table.Column<int>(type: "int", nullable: true),
                    OpenCartCategoryId = table.Column<int>(type: "int", nullable: true),
                    ParentCategoryId = table.Column<int>(type: "int", nullable: true),
                    ShowInMenu = table.Column<bool>(type: "bit", nullable: false),
                    SortOrder = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReversalMovementId = table.Column<int>(type: "int", nullable: true),
                    BatchNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    SerialNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ExpiryDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ScannedBarcode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    IsScannedMovement = table.Column<bool>(type: "bit", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApiCallLogs_Endpoint_TimestampUtc",
                table: "ApiCallLogs",
                columns: new[] { "Endpoint", "TimestampUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_ApiCallLogs_TimestampUtc",
                table: "ApiCallLogs",
                column: "TimestampUtc");

            migrationBuilder.CreateIndex(
                name: "IX_BarcodeScanLogs_Format_TimestampUtc",
                table: "BarcodeScanLogs",
                columns: new[] { "Format", "TimestampUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_BarcodeScanLogs_TimestampUtc",
                table: "BarcodeScanLogs",
                column: "TimestampUtc");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CircuitStateLogs_NewState_TransitionTimeUtc",
                table: "CircuitStateLogs",
                columns: new[] { "NewState", "TransitionTimeUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_CircuitStateLogs_TransitionTimeUtc",
                table: "CircuitStateLogs",
                column: "TransitionTimeUtc");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryLots_ProductId_Status_ExpiryDate",
                table: "InventoryLots",
                columns: new[] { "ProductId", "Status", "ExpiryDate" });

            migrationBuilder.CreateIndex(
                name: "IX_OfflineQueue_CreatedDate",
                table: "OfflineQueue",
                column: "CreatedDate");

            migrationBuilder.CreateIndex(
                name: "IX_OfflineQueue_Status_NextAttemptAt",
                table: "OfflineQueue",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_WarehouseId_IsActive",
                table: "Products",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SyncRetryItems_SyncType_IsResolved_NextRetryUtc",
                table: "SyncRetryItems",
                columns: new[] { "SyncType", "IsResolved", "NextRetryUtc" });
