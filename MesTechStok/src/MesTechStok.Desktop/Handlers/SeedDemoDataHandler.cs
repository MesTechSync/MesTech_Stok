...
#pragma warning disable CS0618 // Obsolete Core.AppDbContext — SeedDemoDataAsync() lives on Core context, requires extraction to ISeedService (TODO H33)
...
/// <summary>
/// TODO H33: Extract SeedDemoDataAsync() from Core.AppDbContext into an ISeedService,
///   then inject Infrastructure.Persistence.AppDbContext here.
///   Blocked: SeedDemoDataAsync() is a 200+ line method on Core.AppDbContext with Core.Data.Models references.
/// </summary>
...
#pragma warning disable CS0618 // TODO H33: Core.AppDbContext still needed for SeedDemoDataAsync()
