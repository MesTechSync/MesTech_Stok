...
public sealed class ViewModelFactory : IViewModelFactory
{
    ...
    public ObservableObject? Create(string viewName)
    {
        return viewName switch
        {
            ...
            "Etsy" => _provider.GetService<EtsyAvaloniaViewModel>(),
            "Shopify" => _provider.GetService<ShopifyAvaloniaViewModel>(),
            "WooCommerce" => _provider.GetService<WooCommerceAvaloniaViewModel>(),
            "Zalando" => _provider.GetService<ZalandoAvaloniaViewModel>(),
            ...
            "LogViewer" => _provider.GetService<LogViewerAvaloniaViewModel>(),
            "Export" => _provider.GetService<ExportAvaloniaViewModel>(),
