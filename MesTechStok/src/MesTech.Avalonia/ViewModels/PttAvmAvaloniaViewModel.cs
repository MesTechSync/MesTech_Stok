...
public partial class PttAvmAvaloniaViewModel : ViewModelBase
{
    ...
    public override async Task LoadAsync()
    {
        ...
        {
            var result = await _mediator.Send(new GetPlatformDashboardQuery(_currentUser.TenantId, PlatformType.PttAVM), ct) ?? new PlatformDashboardDto();
            ...
            ApplyFilter();
        }, "PTT AVM verileri yuklenirken hata");
    }
