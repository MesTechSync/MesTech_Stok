...
public partial class OzonAvaloniaViewModel : ViewModelBase
{
    ...
    public override async Task LoadAsync()
    {
        ...
        {
            var result = await _mediator.Send(new GetPlatformDashboardQuery(_currentUser.TenantId, PlatformType.Ozon), ct) ?? new PlatformDashboardDto();
            ...
            ApplyFilter();
        }, "Ozon verileri yuklenirken hata");
    }
