...
public partial class ShopifyAvaloniaViewModel : ViewModelBase
{
    ...
    public override async Task LoadAsync()
    {
        ...
        {
            var result = await _mediator.Send(new GetPlatformDashboardQuery(_currentUser.TenantId, PlatformType.Shopify), ct) ?? new PlatformDashboardDto();
            ...
            ApplyFilter();
        }, "Shopify verileri yuklenirken hata");
    }
