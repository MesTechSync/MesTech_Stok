    ...
    public override void OnFrameworkInitializationCompleted()
    {
        ...
        _host = Host.CreateDefaultBuilder()
            ...
            .ConfigureServices((ctx, services) =>
            {
                ...
                services.AddTransient<CampaignAvaloniaViewModel>();  // G105: Kampanya Yönetim
                ...
                services.AddTransient<ZalandoAvaloniaViewModel>();
                ...
                services.AddTransient<CommissionCompareAvaloniaViewModel>();
                ...
                services.AddTransient<BillingAvaloniaViewModel>();
                ...
                services.AddTransient<ViewModels.Accounting.TaxRecordAvaloniaViewModel>();
                ...
                services.AddTransient<PlatformConnectionTestAvaloniaViewModel>();
            })
            .Build();
