...
/// <summary>
/// HepsiburadaAdapter failure-mode hardening tests.
...
public class HepsiburadaAdapterHardeningTests : IClassFixture<WireMockFixture>, IDisposable
{
    private readonly WireMockFixture _fixture;
    private readonly WireMockServer _server;
    private readonly ILogger<HepsiburadaAdapter> _logger;

    private const string MerchantId = "hb-test-merchant";

    private static readonly Dictionary<string, string> TestCredentials = new()
    {
        ["MerchantId"] = MerchantId,
        ["ApiKey"] = "hb-hardening-key"
    };

    public HepsiburadaAdapterHardeningTests(WireMockFixture fixture)
    {
        _fixture = fixture;
        _fixture.Reset();
    ...
    private HepsiburadaAdapter CreateAdapter(TimeSpan? timeout = null)
    {
    ...
    public async Task TestConnection_NetworkError_GracefulFail()
    {
        ...
        var adapter = new HepsiburadaAdapter(httpClient, _logger);
