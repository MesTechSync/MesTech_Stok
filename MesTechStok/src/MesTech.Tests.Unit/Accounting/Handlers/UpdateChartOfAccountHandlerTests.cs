...
/// <summary>
/// UpdateChartOfAccountHandler tests — account name update and not-found guard.
/// </summary>
[Trait("Category", "Unit")]
...
public class UpdateChartOfAccountHandlerTests
{
    ...
    public async Task Handle_ValidCommand_ReturnsTrueAndCallsUpdateAsync()
    {
        ...
        var command = new UpdateChartOfAccountCommand(account.Id, "Kasa TL");
        ...
        _repoMock.Verify(
            r => r.UpdateAsync(It.Is<ChartOfAccounts>(a => a.Name == "Kasa TL"),
    ...
    public async Task Handle_AccountNotFound_ReturnsFalse()
    {
        ...
        var command = new UpdateChartOfAccountCommand(missingId, "YeniIsim");
    ...
    public async Task Handle_SystemAccount_ThrowsInvalidOperationException()
    {
        ...
        var command = new UpdateChartOfAccountCommand(account.Id, "YeniIsim");
