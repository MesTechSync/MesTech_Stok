...
public class GetOrderListValidatorTests
{
    private readonly GetOrderListValidator _sut = new();
    ...
    private static GetOrderListQuery CreateValidQuery() => new(TenantId: Guid.NewGuid(), Count: 10);
}
