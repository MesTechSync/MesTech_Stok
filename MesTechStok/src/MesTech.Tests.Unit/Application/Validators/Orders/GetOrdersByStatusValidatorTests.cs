...
public class GetOrdersByStatusValidatorTests
{
    private readonly GetOrdersByStatusValidator _sut = new();
    ...
    private static GetOrdersByStatusQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
