...
public class GetStoreSettingsValidatorTests
{
    private readonly GetStoreSettingsValidator _sut = new();
    ...
    private static GetStoreSettingsQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
