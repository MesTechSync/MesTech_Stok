...
public class GetImportSettingsValidatorTests
{
    private readonly GetImportSettingsValidator _sut = new();
    ...
    private static GetImportSettingsQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
