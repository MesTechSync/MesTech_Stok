...
public class GetOnboardingProgressValidatorTests
{
    private readonly GetOnboardingProgressValidator _sut = new();
    ...
    private static GetOnboardingProgressQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
