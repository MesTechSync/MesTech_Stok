...
public class GetV5ReadinessCheckValidatorTests
{
    private readonly GetV5ReadinessCheckValidator _sut = new();
    ...
    private static GetV5ReadinessCheckQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
