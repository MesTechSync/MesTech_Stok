...
public class GetPlatformMessagesValidatorTests
{
    private readonly GetPlatformMessagesValidator _sut = new();
    ...
    private static GetPlatformMessagesQuery CreateValidQuery() => new(TenantId: Guid.NewGuid(), Page: 1, PageSize: 20);
}
