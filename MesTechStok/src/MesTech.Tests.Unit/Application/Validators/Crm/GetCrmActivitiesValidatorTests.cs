...
public class GetCrmActivitiesValidatorTests
{
    private readonly GetCrmActivitiesValidator _sut = new();
    ...
    private static GetCrmActivitiesQuery CreateValidQuery() => new(TenantId: Guid.NewGuid(), Page: 1, PageSize: 20);
}
