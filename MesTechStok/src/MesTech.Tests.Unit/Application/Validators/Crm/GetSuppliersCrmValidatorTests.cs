...
public class GetSuppliersCrmValidatorTests
{
    private readonly GetSuppliersCrmValidator _sut = new();
    ...
    private static GetSuppliersCrmQuery CreateValidQuery() => new(TenantId: Guid.NewGuid(), Page: 1, PageSize: 20, SearchTerm: "test");
}
