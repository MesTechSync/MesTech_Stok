...
public class GetContactsPagedValidatorTests
{
    private readonly GetContactsPagedValidator _sut = new();
    ...
    private static GetContactsPagedQuery CreateValidQuery() => new(TenantId: Guid.NewGuid(), Page: 1, PageSize: 20, Search: "test");
}
