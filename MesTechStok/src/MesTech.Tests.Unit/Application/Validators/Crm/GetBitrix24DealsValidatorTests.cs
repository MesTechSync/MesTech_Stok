...
public class GetBitrix24DealsValidatorTests
{
    private readonly GetBitrix24DealsValidator _sut = new();
    ...
    private static GetBitrix24DealsQuery CreateValidQuery() => new(TenantId: Guid.NewGuid(), Page: 1, PageSize: 20);
}
