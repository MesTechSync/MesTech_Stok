...
public class GetLeadsValidatorTests
{
    private readonly GetLeadsValidator _sut = new();
    ...
    private static GetLeadsQuery CreateValidQuery() => new(TenantId: Guid.NewGuid(), Page: 1, PageSize: 20);
}
