...
public class GetDealsValidatorTests
{
    private readonly GetDealsValidator _sut = new();
    ...
    private static GetDealsQuery CreateValidQuery() => new(TenantId: Guid.NewGuid(), Page: 1, PageSize: 20);
}
