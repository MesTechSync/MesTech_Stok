...
public class GetCrmSettingsValidatorTests
{
    private readonly GetCrmSettingsValidator _sut = new();
    ...
    private static GetCrmSettingsQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
