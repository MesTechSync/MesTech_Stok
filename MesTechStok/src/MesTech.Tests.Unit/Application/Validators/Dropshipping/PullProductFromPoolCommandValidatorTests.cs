...
public class PullProductFromPoolCommandValidatorTests
{
    private readonly PullProductFromPoolCommandValidator _validator = new();

    private static PullProductFromPoolCommand CreateValidCommand() => new(
