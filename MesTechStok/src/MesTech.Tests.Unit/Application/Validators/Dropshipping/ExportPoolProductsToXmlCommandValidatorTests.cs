...
public class ExportPoolProductsToXmlCommandValidatorTests
{
    private readonly ExportPoolProductsToXmlCommandValidator _validator = new();

    private static ExportPoolProductsToXmlCommand CreateValidCommand() => new(
        PoolId: Guid.NewGuid(),
