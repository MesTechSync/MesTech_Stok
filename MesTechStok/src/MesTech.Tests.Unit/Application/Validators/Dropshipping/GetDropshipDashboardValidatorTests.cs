...
public class GetDropshipDashboardValidatorTests
{
    private readonly GetDropshipDashboardValidator _sut = new();
    ...
    private static GetDropshipDashboardQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
