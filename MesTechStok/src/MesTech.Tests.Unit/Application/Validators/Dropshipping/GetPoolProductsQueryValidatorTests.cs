...
public class GetPoolProductsQueryValidatorTests
{
    private readonly GetPoolProductsQueryValidator _sut = new();
    ...
    private static GetPoolProductsQuery CreateValidQuery() => new(Page: 1, PageSize: 20, Search: "test");
}
