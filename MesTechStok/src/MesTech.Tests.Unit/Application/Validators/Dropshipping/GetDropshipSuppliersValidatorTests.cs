...
public class GetDropshipSuppliersValidatorTests
{
    private readonly GetDropshipSuppliersValidator _sut = new();
    ...
    private static GetDropshipSuppliersQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
