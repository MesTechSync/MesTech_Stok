...
public class GetExportHistoryQueryValidatorTests
{
    private readonly GetExportHistoryQueryValidator _sut = new();
    ...
    private static GetExportHistoryQuery CreateValidQuery() => new(Page: 1, PageSize: 20);
}
