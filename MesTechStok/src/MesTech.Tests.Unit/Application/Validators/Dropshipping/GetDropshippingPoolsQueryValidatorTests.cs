...
public class GetDropshippingPoolsQueryValidatorTests
{
    private readonly GetDropshippingPoolsQueryValidator _sut = new();
    ...
    private static GetDropshippingPoolsQuery CreateValidQuery() => new(Page: 1, PageSize: 20);
}
