...
{
    private readonly GetProductsValidator _sut = new();
    ...
    private static GetProductsQuery CreateValidQuery() => new(TenantId: Guid.NewGuid(), Page: 1, PageSize: 20, SearchTerm: "test");
}
