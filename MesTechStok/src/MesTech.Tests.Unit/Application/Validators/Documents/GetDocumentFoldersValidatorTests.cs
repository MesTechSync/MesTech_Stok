...
public class GetDocumentFoldersValidatorTests
{
    private readonly GetDocumentFoldersValidator _sut = new();
    ...
    private static GetDocumentFoldersQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
