...
public class GetPlatformHealthValidatorTests
{
    private readonly GetPlatformHealthValidator _sut = new();
    ...
    private static GetPlatformHealthQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
