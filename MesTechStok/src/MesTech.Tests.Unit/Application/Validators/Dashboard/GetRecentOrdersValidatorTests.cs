...
public class GetRecentOrdersValidatorTests
{
    private readonly GetRecentOrdersValidator _sut = new();
    ...
    private static GetRecentOrdersQuery CreateValidQuery() => new(TenantId: Guid.NewGuid(), Count: 10);
}
