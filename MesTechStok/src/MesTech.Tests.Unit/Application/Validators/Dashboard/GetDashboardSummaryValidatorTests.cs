...
public class GetDashboardSummaryValidatorTests
{
    private readonly GetDashboardSummaryValidator _sut = new();
    ...
    private static GetDashboardSummaryQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
