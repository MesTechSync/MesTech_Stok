...
public class GetRevenueChartValidatorTests
{
    private readonly GetRevenueChartValidator _sut = new();
    ...
    private static GetRevenueChartQuery CreateValidQuery() => new(TenantId: Guid.NewGuid(), Days: 10);
}
