...
public class GetSalesTodayValidatorTests
{
    private readonly GetSalesTodayValidator _sut = new();
    ...
    private static GetSalesTodayQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
