...
public class GetOrdersPendingValidatorTests
{
    private readonly GetOrdersPendingValidator _sut = new();
    ...
    private static GetOrdersPendingQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
