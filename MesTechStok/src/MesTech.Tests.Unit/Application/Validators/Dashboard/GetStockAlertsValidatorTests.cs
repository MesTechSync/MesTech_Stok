...
public class GetStockAlertsValidatorTests
{
    private readonly GetStockAlertsValidator _sut = new();
    ...
    private static GetStockAlertsQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
