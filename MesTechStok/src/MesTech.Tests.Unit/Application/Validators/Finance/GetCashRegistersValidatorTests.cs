...
public class GetCashRegistersValidatorTests
{
    private readonly GetCashRegistersValidator _sut = new();
    ...
    private static GetCashRegistersQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
