...
public class GetBankAccountsValidatorTests
{
    private readonly GetBankAccountsValidator _sut = new();
    ...
    private static GetBankAccountsQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
