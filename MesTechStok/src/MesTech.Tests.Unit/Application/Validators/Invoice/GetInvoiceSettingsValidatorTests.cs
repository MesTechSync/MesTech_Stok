...
public class GetInvoiceSettingsValidatorTests
{
    private readonly GetInvoiceSettingsValidator _sut = new();
    ...
    private static GetInvoiceSettingsQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
