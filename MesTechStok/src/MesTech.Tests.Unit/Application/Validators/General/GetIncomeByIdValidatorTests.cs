...
public class GetIncomeByIdValidatorTests
{
    private readonly GetIncomeByIdValidator _sut = new();
    ...
    private static GetIncomeByIdQuery CreateValidQuery() => new(Id: Guid.NewGuid());
}
