...
public class GetCategoriesPagedValidatorTests
{
    private readonly GetCategoriesPagedValidator _sut = new();
    ...
    private static GetCategoriesPagedQuery CreateValidQuery() => new(Page: 1, PageSize: 20, SearchTerm: "test");
}
