...
public class GetInventoryPagedValidatorTests
{
    private readonly GetInventoryPagedValidator _sut = new();
    ...
    private static GetInventoryPagedQuery CreateValidQuery() => new(Page: 1, PageSize: 20, SearchTerm: "test");
}
