...
public class GetQuotationByIdValidatorTests
{
    private readonly GetQuotationByIdValidator _sut = new();
    ...
    private static GetQuotationByIdQuery CreateValidQuery() => new(Id: Guid.NewGuid());
}
