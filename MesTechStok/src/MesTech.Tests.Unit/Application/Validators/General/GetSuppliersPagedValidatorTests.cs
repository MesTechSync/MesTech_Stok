...
public class GetSuppliersPagedValidatorTests
{
    private readonly GetSuppliersPagedValidator _sut = new();
    ...
    private static GetSuppliersPagedQuery CreateValidQuery() => new(Page: 1, PageSize: 20, SearchTerm: "test");
}
