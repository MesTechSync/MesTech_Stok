...
public class GetEmployeesValidatorTests
{
    private readonly GetEmployeesValidator _sut = new();
    ...
    private static GetEmployeesQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
