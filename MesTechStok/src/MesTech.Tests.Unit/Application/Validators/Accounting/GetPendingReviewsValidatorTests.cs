...
public class GetPendingReviewsValidatorTests
{
    private readonly GetPendingReviewsValidator _sut = new();
    ...
    private static GetPendingReviewsQuery CreateValidQuery() => new(TenantId: Guid.NewGuid(), PageSize: 20, Page: 1);
}
