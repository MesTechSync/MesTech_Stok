...
public class GetFifoCOGSValidatorTests
{
    private readonly GetFifoCOGSValidator _sut = new();
    ...
    private static GetFifoCOGSQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
