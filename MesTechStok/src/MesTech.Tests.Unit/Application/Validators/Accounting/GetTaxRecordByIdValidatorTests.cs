...
public class GetTaxRecordByIdValidatorTests
{
    private readonly GetTaxRecordByIdValidator _sut = new();
    ...
    private static GetTaxRecordByIdQuery CreateValidQuery() => new(Id: Guid.NewGuid());
}
