...
{
    private readonly GetMonthlySummaryValidator _sut = new();
    ...
    private static GetMonthlySummaryQuery CreateValidQuery() => new(TenantId: Guid.NewGuid(), Year: 2026, Month: 3);
}
