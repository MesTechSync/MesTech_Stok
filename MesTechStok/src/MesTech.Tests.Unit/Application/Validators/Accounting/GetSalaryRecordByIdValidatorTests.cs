...
public class GetSalaryRecordByIdValidatorTests
{
    private readonly GetSalaryRecordByIdValidator _sut = new();
    ...
    private static GetSalaryRecordByIdQuery CreateValidQuery() => new(Id: Guid.NewGuid());
}
