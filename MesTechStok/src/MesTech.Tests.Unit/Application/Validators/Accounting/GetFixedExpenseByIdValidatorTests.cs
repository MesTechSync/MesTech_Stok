...
public class GetFixedExpenseByIdValidatorTests
{
    private readonly GetFixedExpenseByIdValidator _sut = new();
    ...
    private static GetFixedExpenseByIdQuery CreateValidQuery() => new(Id: Guid.NewGuid());
}
