...
public class GetChartOfAccountsValidatorTests
{
    private readonly GetChartOfAccountsValidator _sut = new();
    ...
    private static GetChartOfAccountsQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
