...
public class GetShipmentCostsValidatorTests
{
    private readonly GetShipmentCostsValidator _sut = new();
    ...
    private static GetShipmentCostsQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
