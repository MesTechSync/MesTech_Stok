...
public class GetFixedAssetsValidatorTests
{
    private readonly GetFixedAssetsValidator _sut = new();
    ...
    private static GetFixedAssetsQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
