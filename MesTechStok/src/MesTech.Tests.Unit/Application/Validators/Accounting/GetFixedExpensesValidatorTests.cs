...
public class GetFixedExpensesValidatorTests
{
    private readonly GetFixedExpensesValidator _sut = new();
    ...
    private static GetFixedExpensesQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
