...
public class GetPenaltyRecordsValidatorTests
{
    private readonly GetPenaltyRecordsValidator _sut = new();
    ...
    private static GetPenaltyRecordsQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
