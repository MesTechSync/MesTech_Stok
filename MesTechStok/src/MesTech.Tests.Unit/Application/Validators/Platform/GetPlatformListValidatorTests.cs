...
public class GetPlatformListValidatorTests
{
    private readonly GetPlatformListValidator _sut = new();
    ...
    private static GetPlatformListQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
