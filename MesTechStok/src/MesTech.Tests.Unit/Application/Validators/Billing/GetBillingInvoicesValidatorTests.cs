...
public class GetBillingInvoicesValidatorTests
{
    private readonly GetBillingInvoicesValidator _sut = new();
    ...
    private static GetBillingInvoicesQuery CreateValidQuery() => new(TenantId: Guid.NewGuid());
}
