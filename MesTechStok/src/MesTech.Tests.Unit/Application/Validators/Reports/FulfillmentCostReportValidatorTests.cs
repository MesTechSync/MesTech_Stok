...
public class FulfillmentCostReportValidatorTests
{
    private readonly FulfillmentCostReportValidator _sut = new();

    private static FulfillmentCostReportQuery CreateValidQuery() => new(
