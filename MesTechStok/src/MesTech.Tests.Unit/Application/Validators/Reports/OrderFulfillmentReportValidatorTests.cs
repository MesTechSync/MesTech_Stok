...
[Trait("Category", "Unit")]
public class OrderFulfillmentReportValidatorTests
{
    private readonly OrderFulfillmentReportValidator _sut = new();

    private static OrderFulfillmentReportQuery CreateValidQuery() =>
        new(
