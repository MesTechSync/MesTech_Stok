...
[Trait("Category", "Unit")]
public class PlatformPerformanceReportValidatorTests
{
    private readonly PlatformPerformanceReportValidator _sut = new();

    private static PlatformPerformanceReportQuery CreateValidQuery() =>
        new(
