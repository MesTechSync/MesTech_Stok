...
public class CargoPerformanceReportValidatorTests
{
    private readonly CargoPerformanceReportValidator _sut = new();

    private static CargoPerformanceReportQuery CreateValidQuery() => new(
