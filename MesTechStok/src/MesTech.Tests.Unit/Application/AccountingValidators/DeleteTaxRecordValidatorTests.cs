...
public class DeleteTaxRecordValidatorTests
{
    private readonly DeleteTaxRecordValidator _validator = new();

    private static DeleteTaxRecordCommand ValidCommand() => new(
        Id: Guid.NewGuid()
    );
